...
function ProjectForm({ onAddProject, onCancel }) {
  ...
  function handleSubmit(event) {
    ...
    const swatch = SWATCH_OPTIONS[Math.floor(Math.random() * SWATCH_OPTIONS.length)]
  ...
  return (
    <div className="form-overlay" role="dialog" aria-label="Add new project">
      <form className="project-form" onSubmit={handleSubmit}>
        ...
        <label className="project-form__field">
          ...
          <input
            ...
            placeholder="e.g. Solstice Packaging"
            required
          />
        </label>
